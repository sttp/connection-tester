...
namespace DebugScripts
{
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        private void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                bool isCharacterVisible = i < m_TextComponent.maxVisibleCharacters &&
                                          ...
                                          (m_TextComponent.overflowMode != TextOverflowModes.Page || characterInfo.pageNumber + 1 == m_TextComponent.pageToDisplay);

                if (!isCharacterVisible) continue;

                const float dottedLineSize = 6;
        ...
        private void DrawLineBounds()
        {
            ...
            for (int i = 0; i < lineCount; i++)
            {
                ...
                bool isLineVisible = (lineInfo.characterCount != 1 ||
                                     (firstCharacterInfo.character != 10 && firstCharacterInfo.character != 11 && firstCharacterInfo.character != 0x2028 && firstCharacterInfo.character != 0x2029)) &&
        ...
        // Draw Rectangles
        private static void DrawRectangle(Vector3 BL, Vector3 TR, Color color)
        {
            Gizmos.color = color;
        ...
        private static void DrawDottedRectangle(Vector3 bottomLeft, Vector3 topRight, Color color, float size = 5.0f)
        {
            Handles.color = color;
        ...
        private static void DrawSquare(Vector3 position, float size, Color color)
        {
            Handles.color = color;
        ...
        private static void DrawCrosshair(Vector3 position, float size, Color color)
        {
            Handles.color = color;
        ...
        // Draw Rectangles
        private static void DrawRectangle(Vector3 bl, Vector3 tl, Vector3 tr, Vector3 br, Color color)
        {
            Gizmos.color = color;
